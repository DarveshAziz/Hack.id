...
<nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0 sticky-top shadow-sm">
  ...
  <div class="collapse navbar-collapse" id="navbarCollapse">
    <div class="navbar-nav ms-auto py-0">
      ...
      <a href="hackathons.php" class="nav-item nav-link <?= $current_page == 'hackathons.php' ? 'active' : '' ?>">Hackathons</a>
      <a href="manage_teams.php" class="nav-item nav-link <?= $current_page == 'manage_teams.php' ? 'active' : '' ?>">Teams</a>
    </div>

			...
			<div class="col-md-6 col-lg-6 col-xl-3">
				<div class="footer-item d-flex flex-column">
					<div class="footer-item">
						...
						<p class="mb-3">Match with talented makers, designers, and developers in minutes. Browse live hackathons, assemble a crew, and start shipping — all on Hack.id.</p>
					</div>

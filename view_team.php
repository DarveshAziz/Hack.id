...
body {
  ...
  background-color: #222222; /* Main background color */
...
.container.py-5 h1.h2.mb-1 {
  color: #582ec4; /* Primary color for main title */
  font-weight: 700;
}

a {
  color: #7e57c2; /* A slightly lighter shade of primary for links */
  text-decoration: none;
  transition: color 0.2s ease-in-out;
}

a:hover {
  color: #582ec4; /* Primary color on hover */
  text-decoration: underline;
}

p.text-muted,
.small.text-muted {
  color: #a0a0a0 !important; /* Lighter muted color for dark background */
}
...
.btn-primary {
  background-color: #582ec4; /* Primary color */
  border-color: #582ec4;
  color: #ffffff;
}

.btn-primary:hover, .btn-primary:focus {
  background-color: #4a25a1; /* Darker shade for hover/focus */
  border-color: #4a25a1;
  color: #ffffff;
...
.btn-outline-primary i.fas { /* Ensure icon color matches button text on hover */
    color: inherit;
}
...
.btn-secondary-team:hover, .btn-secondary-team:focus {
...
.card {
  background-color: #2a2a2a; /* Slightly lighter than main bg for depth */
...
.card:hover {
    ...
    box-shadow: 0 10px 25px rgba(88, 46, 196, 0.25); /* Primary color glow on hover */
}
...
.card-title {
  color: #ffffff;
  font-weight: 600;
  margin-bottom: 0.25rem !important; /* Overriding Bootstrap's mb-2 if needed */
}
...
img.img-thumbnail {
  background-color: #2d2d2d;
  border: 2px solid #444444; /* Slightly thicker border */
  padding: 0.3rem;
  max-width: 200px; /* As per inline style */
  border-radius: 0.375rem;
  box-shadow: 0 2px 5px rgba(0,0,0,0.1);
}

img.rounded-circle { /* For avatars in member cards and chat */
  border: 3px solid #582ec4; /* Primary color border for avatars */
  box-shadow: 0 0 10px rgba(88, 46, 196, 0.3); /* Soft glow */
}
...
#chat-box .d-flex.align-items-start {
  margin-bottom: 0.75rem !important; /* Spacing between messages */
}

#chat-box .d-flex.align-items-start > img.rounded-circle.me-2 {
  /* Avatar in chat */
  width: 36px !important; /* Slightly larger chat avatars */
  height: 36px !important;
  border-width: 2px; /* Thinner border for smaller chat avatars */
  box-shadow: 0 0 5px rgba(88, 46, 196, 0.2);
}

#chat-box .small.text-muted strong {
  color: #7e57c2; /* Username color in chat */
  font-weight: 600;
}
#chat-box .small.text-muted { /* Timestamp */
...
#chat-box div > div > div:last-child {
  background-color: #353535; /* Slightly lighter bubble */
  padding: 0.6rem 0.9rem;
  border-radius: 10px; /* More rounded bubbles */
  display: inline-block;
  max-width: calc(100% - 40px); /* Ensure it doesn't overflow too much */
  color: #f0f0f0;
  line-height: 1.4;
...
.input-group .form-control#chat-input {
  ...
  height: calc(1.5em + 1.2rem + 2px); /* Match button height */
}
...
.input-group #chat-send.btn-primary {
  ...
  height: calc(1.5em + 1.2rem + 2px); /* Match input height */
  z-index: 2; /* Ensure button is on top of input border */
}
...
form div.mb-3 > strong { /* For member names in role editor */
  color: #582ec4; /* Primary color for emphasis */
  font-size: 1.1em;
...
.row.mb-4 > .col-md-8 p { /* Team description */
  font-size: 1.05rem;
  color: #cccccc;
  background-color: #282828;
  padding: 1rem;
...
.card-body .small.text-muted {
  font-style: normal; /* Remove italic for better readability if preferred */
...
@media (max-width: 767.98px) {
  ...
  .col-md-4.text-end {
    text-align: left !important; /* Stack edit button neatly on mobile */
    margin-top: 1rem;
  }
  .card {
    margin-bottom: 1.5rem; /* Ensure cards don't touch if they wrap */
  }
  .card:hover {
    transform: translateY(-3px) scale(1.01); /* Less dramatic hover on mobile */
  }
  #chat-box div > div > div:last-child { /* Message body on mobile */
...
@media (max-width: 575.98px) {
  .display-name-roles { /* If you had a wrapper for name and roles */
    text-align: center;
  }
  .col-6.col-md-4.col-lg-3 { /* Member cards column */
    flex: 0 0 auto;
